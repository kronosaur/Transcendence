...
CG16bitRegion::CG16bitRegion (void) : m_pList(NULL), m_iCount(0)
...
void CG16bitRegion::CreateFromSimplePolygon (int iVertexCount, SPoint *pVertexList)
...
void CG16bitRegion::GetBounds (RECT *retrcRect) const
...
void CG16bitRegion::Fill (CG16bitImage &Dest, int x, int y, WORD wColor) const
...
void CG16bitRegion::FillTrans (CG16bitImage &Dest, int x, int y, WORD wColor, DWORD byOpacity) const
