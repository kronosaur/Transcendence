...
ALERROR CHumanInterface::WMCreate (HMODULE hModule, HWND hWnd, SHIOptions &Options, IHIController *pController)
...
//	pController will be owned by this object and will be freed when on WMDestroy
	...
	ScreenOptions.m_bMultiMonitorMode = Options.m_bMultiMonitorMode;
